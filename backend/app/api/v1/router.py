...
from app.api.v1 import space, items, search, reminders, speech, auth, family, audit, floor_plan, data_policy, notifications
...
router.include_router(notifications.router, prefix="/notifications", tags=["Notifications"], dependencies=require_auth)
